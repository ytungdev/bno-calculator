        ...
        <>
            <Layout home>
                ...
                <section className={utilStyles.headingMd}>
                    <h3>Nomenclature</h3>
                    <p>
                        This web application only focus on some of the conditions for ILR/Citizenship, and for simplicity, we will use the following <i><u>code</u></i> to reference certain condition:
                    </p>
                    <ul>
                    ...
                    <ul>
                        <li>Only whole day absent is counted. <a target="_blank" href="https://www.gov.uk/government/publications/continuous-residence/continuous-residence-guidance-accessible-version#count-whole-days-1200-am-to-1200-pm"><sup>[Source]</sup></a></li>
                        <ul>
                            <li><i><u>Case 1</u></i> : Peter left UK at 08:00 1 JAN 2023 and returned at 21:00 2 JAN 2023.
                                <br />
                                As he did not absent for full 24 hr in both day, therefore 0 day was counted as absent.
                            </li>
                            <li><i><u>Case 2</u></i> : Peter left UK at 08:00 1 JAN 2023 and returned at 21:00 3 JAN 2023.
                                <br />
                                He did not absent for full 24 hr in day 1 and 3(1/1 and 3/1), but the full 24hr of day 2(2/1) is absented from UK, therefore 1 day was counted as absent.
                            </li>
                        </ul>
                        <li>The continuous residence periods will be calculated by counting back from:
                            <ul>
                                <li><i><u>If entered UK within 180 day after issuing visa</u></i> :  the date of issue of the BN(O) visa.
                                    <sup>
                                ...
                                <li><i><u>If entered UK <b>after</b> 180 day after issuing visa</u></i> :  
                                    the date of entering UK.
                                    <ul>
                                        <li>When absent from UK for more than 180 days, '5 continuous years' reset.</li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                ...
                <section>
                    <h3>Reference</h3>
                    <details open>
                        <summary><>Official Conditions to apply for:</></summary>
                        <div style={{ marginLeft: "20px" }}>
                            <details>
                                <summary style={{ margin: "1rem auto" }}>
                                    <u>Indefinite Leave to Remain (ILR)</u>
                                    <sup>
